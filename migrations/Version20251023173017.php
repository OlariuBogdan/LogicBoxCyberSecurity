 ...
 */
final class Version20251023173017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pricing_plan (id SERIAL NOT NULL, name VARCHAR(50) NOT NULL, price INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE pricing_plan_benefit (id SERIAL NOT NULL, pricing_plan_id INT NOT NULL, name VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
